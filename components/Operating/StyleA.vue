...
#operatingA(class="h-100")
  div
    ...
    button(@click="changeOperating('C')") C
  div
    el-form
  ...
  div
    ...
    .operating-4
        button.button__danger.button__lg.text__bold(@click="checkOrder(0)" v-if="buttonType == 0") 多單
        button.button__success.button__lg.text__bold(@click="checkOrder(1)" v-if="buttonType == 1") 空單
        el-dialog(
